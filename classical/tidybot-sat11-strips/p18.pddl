(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (target-goal target0 x6 y4)
   (target-goal target0 x1 y2)
   (target-goal target1 x6 y5)
   (target-goal target2 x7 y4)
   (target-goal target2 x2 y6)
   (target-goal target3 x7 y5)
   ...
   (target-pos target0 x1 y2)
   (target-pos target1 x3 y6)
   (target-pos target2 x2 y2)
   (target-pos target3 x2 y6)
