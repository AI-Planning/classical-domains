(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (target-goal target0 x4 y3)
   (target-goal target0 x1 y5)
   (target-goal target1 x4 y4)
   (target-goal target1 x1 y5)
   (target-goal target2 x5 y3)
   (target-goal target2 x1 y5)
   (target-goal target3 x5 y4)
   (target-goal target3 x1 y5)
   ...
   (target-pos target0 x5 y3)
   (target-pos target1 x5 y4)
   (target-pos target2 x1 y6)
   (target-pos target3 x4 y4)
