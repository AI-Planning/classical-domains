(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (target-goal target0 x3 y4)
   (target-goal target0 x5 y1)
   (target-goal target1 x3 y5)
   (target-goal target2 x4 y4)
   (target-goal target2 x3 y1)
   (target-goal target3 x4 y5)
   ...
   (target-pos target0 x4 y4)
   (target-pos target1 x3 y4)
   (target-pos target2 x5 y1)
   (target-pos target3 x3 y1)
