(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (target-goal target0 x2 y3)
   (target-goal target1 x2 y4)
   (target-goal target1 x7 y4)
   (target-goal target2 x3 y3)
   (target-goal target3 x3 y4)
   ...
   (target-pos target0 x3 y7)
   (target-pos target1 x3 y4)
   (target-pos target2 x2 y4)
