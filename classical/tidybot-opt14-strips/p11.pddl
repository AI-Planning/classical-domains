(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (target-goal target0 x3 y2)
   (target-goal target1 x3 y3)
   (target-goal target2 x4 y2)
   (target-goal target3 x4 y3)
   ...
   (target-pos target0 x3 y3)
   (target-pos target1 x4 y2)
   (target-pos target2 x3 y2)
   (target-pos target3 x4 y3)
